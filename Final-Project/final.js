    ...
    $(function() {
      $("#yes52").on("click", function() {
        if ($('#check52').hasClass("hidden"))
          $("#check52").removeClass("hidden");
          else $("#check52").addClass("hidden");
        });
      });

      $(function() {
        $("#no52").on("click", function() {
          if ($('#x52').hasClass("hidden"))
          $("#x52").removeClass("hidden");
          else $("#x52").addClass("hidden");
        });
      });
    ...
    $(function() {
      $("#yes53").on("click", function() {
        if ($('#check53').hasClass("hidden"))
          $("#check53").removeClass("hidden");
          else $("#check53").addClass("hidden");
        });
      });

      $(function() {
        $("#no53").on("click", function() {
          if ($('#x53').hasClass("hidden"))
          $("#x53").removeClass("hidden");
          else $("#x53").addClass("hidden");
        });
      });
...
//54
  ...
  //Table conditional
    $(function() {
      $("#yes54").on("click", function() {
        if ($('#check54').hasClass("hidden"))
          $("#check54").removeClass("hidden");
          else $("#check54").addClass("hidden");
        });
      });

      $(function() {
        $("#no54").on("click", function() {
          if ($('#x54').hasClass("hidden"))
          $("#x54").removeClass("hidden");
          else $("#x54").addClass("hidden");
        });
      });
    ...
    $(function() {
      $("#yes55").on("click", function() {
        if ($('#check55').hasClass("hidden"))
          $("#check55").removeClass("hidden");
          else $("#check55").addClass("hidden");
        });
      });

      $(function() {
        $("#no55").on("click", function() {
          if ($('#x55').hasClass("hidden"))
          $("#x55").removeClass("hidden");
    ...
    $(function() {
      $("#yes56").on("click", function() {
        if ($('#check56').hasClass("hidden"))
          $("#check56").removeClass("hidden");
          else $("#check56").addClass("hidden");
        });
      });

      $(function() {
        $("#no56").on("click", function() {
          if ($('#x56').hasClass("hidden"))
          $("#x56").removeClass("hidden");
          else $("#x56").addClass("hidden");
        });
      });
    ...
    $(function() {
      $("#yes57").on("click", function() {
        if ($('#check57').hasClass("hidden"))
          $("#check57").removeClass("hidden");
          else $("#check57").addClass("hidden");
        });
      });

      $(function() {
        $("#no57").on("click", function() {
          if ($('#x57').hasClass("hidden"))
          $("#x57").removeClass("hidden");
    ...
    $(function() {
      $("#yes58").on("click", function() {
        if ($('#check58').hasClass("hidden"))
          $("#check58").removeClass("hidden");
          else $("#check58").addClass("hidden");
        });
      });

      $(function() {
        $("#no58").on("click", function() {
          if ($('#x58').hasClass("hidden"))
          $("#x58").removeClass("hidden");
    ...
    $(function() {
      $("#yes59").on("click", function() {
        if ($('#check59').hasClass("hidden"))
          $("#check59").removeClass("hidden");
          else $("#check59").addClass("hidden");
        });
      });

      $(function() {
        $("#no59").on("click", function() {
          if ($('#x59').hasClass("hidden"))
          $("#x59").removeClass("hidden");
    ...
    $(function() {
      $("#yes60").on("click", function() {
        if ($('#check60').hasClass("hidden"))
          $("#check60").removeClass("hidden");
          else $("#check60").addClass("hidden");
        });
      });

      $(function() {
        $("#no60").on("click", function() {
          if ($('#x60').hasClass("hidden"))
          $("#x60").removeClass("hidden");
    ...
    $(function() {
      $("#yes61").on("click", function() {
        if ($('#check61').hasClass("hidden"))
          $("#check61").removeClass("hidden");
          else $("#check61").addClass("hidden");
        });
      });

      $(function() {
        $("#no61").on("click", function() {
          if ($('#x61').hasClass("hidden"))
          $("#x61").removeClass("hidden");
    ...
    $(function() {
      $("#yes62").on("click", function() {
        if ($('#check62').hasClass("hidden"))
          $("#check62").removeClass("hidden");
          else $("#check62").addClass("hidden");
        });
      });

      $(function() {
        $("#no62").on("click", function() {
          if ($('#x62').hasClass("hidden"))
          $("#x62").removeClass("hidden");
    ...
    $(function() {
      $("#yes63").on("click", function() {
        if ($('#check63').hasClass("hidden"))
          $("#check63").removeClass("hidden");
          else $("#check63").addClass("hidden");
        });
      });

      $(function() {
        $("#no63").on("click", function() {
          if ($('#x63').hasClass("hidden"))
          $("#x63").removeClass("hidden");
    ...
    $(function() {
      $("#yes64").on("click", function() {
        if ($('#check64').hasClass("hidden"))
          $("#check64").removeClass("hidden");
          else $("#check64").addClass("hidden");
        });
      });

      $(function() {
        $("#no64").on("click", function() {
          if ($('#x64').hasClass("hidden"))
          $("#x64").removeClass("hidden");
    ...
    $(function() {
      $("#yes65").on("click", function() {
        if ($('#check65').hasClass("hidden"))
          $("#check65").removeClass("hidden");
          else $("#check65").addClass("hidden");
        });
      });

      $(function() {
        $("#no65").on("click", function() {
          if ($('#x65').hasClass("hidden"))
          $("#x65").removeClass("hidden");
